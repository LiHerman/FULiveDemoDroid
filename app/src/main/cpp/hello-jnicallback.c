...
Java_com_faceunity_app_base_BaseFaceUnityDemoActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
//    bool ttt= false;
//    LOGI("booltest - %d", tt);
//    LOGI("booltest t - %d", ttt);
    LOGI("curPriority - %d, priority - %d", 1, 2);
    int64_t totalCost = 20;
    int32_t mMaxCost =1 ;
    int32_t curCost = 2;
//    LOGI("wouldEvictLocked - step3 totalCost="+totalCost);
    LOGI("wouldEvictLocked - %s", "======Find evicted clients");
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "com/faceunity/app/utils/JniHandler");
...
Java_com_faceunity_app_base_BaseFaceUnityDemoActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_faceunity_app_base_BaseFaceUnityDemoActivity_StopTicks(JNIEnv *env, jobject instance) {
